...
<div class="jumbotron text-center">
    <div class="container">
         <br><br>
         <h2>Sorry, your username and password were not recognized.</h2><br><br><br><br><br><br><br><br><br><br><br><br>
 ...
 <blockquote class="blockquote text-left">
  ...
  <footer class="blockquote-footer">
    <p style="text-align: left">--future@technology<cite title="Source Title">.com</cite></p>
    <p style="text-align: right">Developed By:- Shaikh Fayazul Abeddin.</p>
  </footer>
</blockquote>
</body>
</html>